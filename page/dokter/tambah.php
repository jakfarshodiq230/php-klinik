...
$carikode = mysqli_query($koneksi, "select max(kode_dokter) from dokter") or die (mysql_error());
  // menjadikannya array
...
<div class="row">
    <div class="col-lg-12">
    <h3 class="page-header"><strong>Input Data Dokter</strong></h3>
    </div>
        <!-- /.col-lg-12 -->
</div>
        <!-- /.row -->
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">Input Data Dokter</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">                                    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Nama Pasien" name="nama" required>
                                    </div>
                                    <div class="form-group">
    ...
    if ($simpan) {
        ...
        $sql = $koneksi -> query ("INSERT INTO dokter (kode_dokter,nama_dokter,jenis_kelamin,tanggal_lahir,sepesialis,alamat,no_hp)  VALUES ('$kode_dokter', '$nama_dokter','$jenis_kelamin','$tanggal','$sepesialis','$alamat','$no_hp')");
