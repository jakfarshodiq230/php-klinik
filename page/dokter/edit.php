<?php
    ...
    $sql = $koneksi -> query ("SELECT * FROM dokter WHERE kode_dokter ='$kode_dokter'");
...
<div class="row">
    <div class="col-lg-12">
    <h3 class="page-header"><strong>Edit Data Dokter</strong></h3>
    </div>
        <!-- /.col-lg-12 -->
</div>
        <!-- /.row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">                                    
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Nama Pasien" name="nama" value="<?php echo $tampil['nama_dokter'];?>">
                                    </div>
                                        <div class="form-group">
    ...
    if ($simpan) {
        ...
        $sql = $koneksi -> query ("UPDATE dokter SET nama_dokter='$nama_dokter',Jenis_kelamin='$jenis_kelamin',tanggal_lahir='$tanggal',  sepesialis='$sepesialis',alamat='$alamat',no_hp='$no_hp' where kode_dokter ='$kode_dokter'");
